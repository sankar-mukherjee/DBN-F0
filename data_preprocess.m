...
%% zero mean with unit variance with [-1 1]
% f0_5state = f0_5state - mean(f0_5state);
% f0_5state = f0_5state / std(f0_5state);
% f0_5state = f0_5state / norm(f0_5state);
% 
% delta = delta - mean(delta);
% delta = delta / std(delta);
% delta = delta / norm(delta);
% 
% delta_delta = delta_delta - mean(delta_delta);
% delta_delta = delta_delta / std(delta_delta);
% delta_delta = delta_delta / norm(delta_delta);
...
test_dy = delta(n_test,:);    
test_ddy = delta_delta(n_test,:); 
